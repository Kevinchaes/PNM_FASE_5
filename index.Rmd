...
### **Lista con todos los puntos de monitoreo de la cuenca**
```{r}
st_drop_geometry(sf_general_distritos_ultima_fecha) %>% 
  select(Código = provincia, Cuenca = canton, Ubicación = distrito, Positivos = positivos, Activos = activos, Recuperados = recuperados, Fallecidos = fallecidos) %>%
